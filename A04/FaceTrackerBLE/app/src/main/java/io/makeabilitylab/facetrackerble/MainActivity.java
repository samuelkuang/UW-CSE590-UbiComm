...
public class MainActivity extends AppCompatActivity implements BLEListener{
    ...
    private static final int RC_HANDLE_RECORD_AUDIO_PERM = 3;
    ...
    private final String TARGET_BLE_DEVICE_NAME = "SamuLab";
    ...
    private void requestAudioPermission() {
        Log.w(TAG, "Ausio permission is not granted. Requesting permission");
        ...
        // Snackbars are like Toasts
        // See: https://stackoverflow.com/q/34432339
        Snackbar.make(mGraphicOverlay, R.string.permission_record_audio_rationale,
                Snackbar.LENGTH_INDEFINITE)
                .setAction(R.string.ok, listener)
                .show();
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        else if (requestCode == RC_HANDLE_RECORD_AUDIO_PERM) {
            if (grantResults.length != 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
